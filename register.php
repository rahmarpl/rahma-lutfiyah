...
<head>
    ...
    <link rel="icon" type="imagejpg/" href="bg5.jpg">
    <link rel="stylesheet" href="style.css"/>
    
</head>
<body style="background-image: url('bg5.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
<div id="wrapper">
    <div id="header">
    <h1 style="color: #336633"> Registrasi Dulu</h1>
    <?php
    ...
    <div style="text-align: center; margin-bottom: 10px;">
        <a href="login.php" style="text-decoration: none; color: #000000;">Sudah punya akun? Login di sini!</a>
    </div>
    <?php } ?>
    ...
    <div id="footer">
    <h4 style="color: #6b3b08">Selamat Datang</h4>
    </div>
</div>
