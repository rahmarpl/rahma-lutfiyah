...
<head>
    ...
    <title>Halaman website Rahma Lutfiyah</title>
...
<body>
    ...
    <div class="section">
        <div class="container">
            <h3 style="text-align: center; margin-top: 40px; margin-bottom: 20px;">Kategori Koleksiku</h3>
            <div class="category-container">
                ...
                ?>
                    <div class="category-item" style="margin-top: 20px; margin-bottom: 20px;">
                        ...
                        <img src="bg4.png" alt="<?php echo $data['namaalbum'] ?>" class="category-icon">
